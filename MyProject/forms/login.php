...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="../databasefunction/login.php" method="POST">
        <div>
      ...
      Adakah anda mempunyai akaun?
        <a href="../forms/catogarize.php" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign Up</a>
      </p>
    </div>
  </div>
